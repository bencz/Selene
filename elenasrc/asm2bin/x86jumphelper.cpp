...
void x86JumpHelper :: writeJxxForward(const TCHAR* labelName, int prefix, bool shortJump)
{
...
void x86JumpHelper :: writeJxxBack(const TCHAR* label, int prefix, bool shortJump)
{
   if (shortJump) {
...
void x86JumpHelper :: writeJmpForward(const TCHAR* labelName, bool shortJump)
{
   int label = _labels.get(labelName);
   if (label == 0) {
      label = _labels.Count() + 1;
...
void x86JumpHelper :: writeJmpBack(const TCHAR* label, bool shortJump)
{
   if (shortJump) {
...
void x86JumpHelper :: writeLoopBack(const TCHAR* label)
{
   _helper.writeLoopBack(_labels.get(label));
}

void x86JumpHelper :: writeLoopForward(const TCHAR* labelName)
{
   int label = _labels.get(labelName);
   if (label == 0) {
      label = _labels.Count() + 1;
...
void x86JumpHelper :: writeCallBack(const TCHAR* label)
{
   _helper.writeCallBack(_labels.get(label));
}

void x86JumpHelper :: writeCallForward(const TCHAR* labelName)
{
   int label = _labels.get(labelName);
   if (label == 0) {
      label = _labels.Count() + 1;
...
bool x86JumpHelper :: addLabel(const TCHAR* labelName)
{
   int label = _labels.get(labelName);
   if (label == 0) {
      label = _labels.Count() + 1;
