...
public:
   ...
   static void writeModRM(SectionWriter* code, Operand sour, Operand dest)
   {
   ...
   static void writeImm(SectionWriter* code, Operand sour)
   {
      if (sour.type==otDD) {
         if (sour.reference != 0) {
   ...
   static void movMR32disp(SectionWriter* code, OperandType sour, OperandType dest, int sourOffs)
   {
   ...
   static void leaRM32disp(SectionWriter* code, OperandType sour, OperandType dest, int destOffs)
   {
      Operand sourOp(sour);
...
public:
   ...
   x86LabelHelper(SectionWriter* code)
   {
      this->code = code;
   }
};
