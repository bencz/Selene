...
namespace _ELENA_
{
  ...
  // --- ELENA Standard module references ---
   ...
   #define ALLOC_FUNCTION           _T("$package'elena'1")
   #define PREP_FUNCTION            _T("$package'elena'4")
   #define SPREP_FUNCTION           _T("$package'elena'5")
   #define RETURN_FUNCTION          _T("$package'elena'6")
   #define IOCALLN_FUNCTION         _T("$package'elena'7")
   #define SEXIT_FUNCTION           _T("$package'elena'8")
   #define SRETURN_FUNCTION         _T("$package'elena'9")
   #define RRETURNIF_FUNCTION       _T("$package'elena'10")
   #define OCREATE_FUNCTION         _T("$package'elena'11")
   #define OCREATE2_FUNCTION        _T("$package'elena'12")
   #define OCREATE4_FUNCTION        _T("$package'elena'13")
   #define OCREATE6_FUNCTION        _T("$package'elena'14")
   #define OCREATE0_FUNCTION        _T("$package'elena'15")
   #define CALLEXT_FUNCTION         _T("$package'elena'16")
   #define PREPREDIR_FUNCTION       _T("$package'elena'17")
   #define EXITREDIR_FUNCTION       _T("$package'elena'18")
   #define REDIRECT_FUNCTION        _T("$package'elena'19")
   #define RREDIRECT_FUNCTION       _T("$package'elena'20")
   #define GROUP_FUNCTION           _T("$package'elena'21")
   #define IOSWAP_FUNCTION          _T("$package'elena'25")
   #define IOSET_FUNCTION           _T("$package'elena'26")
   #define SHIFT_FUNCTION           _T("$package'elena'28")
   #define UNSHIFT_FUNCTION         _T("$package'elena'29")
   #define IRCALL_FUNCTION          _T("$package'elena'30")
   #define ASSIGN_FUNCTION          _T("$package'elena'34")
   #define CAST_FUNCTION            _T("$package'elena'36")
   #define WIND32PROC               _T("$package'elena'37")
