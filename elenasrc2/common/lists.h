...
template <class Key, class T, bool KeyStored> struct _MemoryMapItem
{
   ...
   {
      if (KeyStored) {
         return (ident_c*)((size_t)this + (size_t)this->key);
      }
      else return key;
   }
   ...
   {
      if (KeyStored) {
         return StringHelper::compare((ident_c*)((size_t)this + (size_t)this->key), key);
      }
   ...
   {
      if (KeyStored) {
         return !StringHelper::greater((ident_c*)((size_t)this + (size_t)this->key), key);
      }
   ...
   {
      if (KeyStored) {
         return StringHelper::greater(key, (ident_c*)((size_t)this + (size_t)this->key));
      }
